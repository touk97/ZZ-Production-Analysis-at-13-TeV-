...
int SM_ZZ_plot3() {
  ...
  TH1F *Hmet_pt_sigQCD  = new TH1F("N_bjets","N_{bjets}",20,binmin,binmax);
  TH1F *Hmet_pt_sigEWK  = new TH1F("Hmet_pt_sigEWK","Hmet_pt_sigEWK",20,binmin,binmax);
  TH1F *Hmet_pt_data  = new TH1F("Hmet_pt_data ","Hmet_pt_data ",20,binmin,binmax);
  TH1F *Hmet_pt_Zjets  = new TH1F("Hmet_pt_Zjets ","Hmet_pt_Zjets ",20,binmin,binmax);
  TH1F *Hmet_pt_WZ  = new TH1F("Hmet_pt_WZ ","Hmet_pt_WZ ",20,binmin,binmax);
  TH1F *Hmet_pt_WW  = new TH1F("Hmet_pt_WW ","Hmet_pt_WW ",20,binmin,binmax);
  TH1F *Hmet_pt_Wt  = new TH1F("Hmet_pt_Wt ","Hmet_pt_Wt ",20,binmin,binmax);
  TH1F *Hmet_pt_tt  = new TH1F("Hmet_pt_tt ","Hmet_pt_tt ",20,binmin,binmax);
  TH1F *Hmet_pt_trib  = new TH1F("Hmet_pt_trib ","Hmet_pt_trib ",20,binmin,binmax);
  TH1F *Hmet_pt_othr  = new TH1F("Hmet_pt_othr ","Hmet_pt_othr ",20,binmin,binmax);
  TH1F *Hmet_pt_signal_sing  = new TH1F("Hmet_pt_signal_sing ","Hmet_pt_signal_sing",20,binmin,binmax);
  ...
  Hmet_pt_sigQCD->GetYaxis()->SetTitleOffset(0.85);
  Hmet_pt_sigQCD->GetYaxis()->SetLabelSize(0.04);
